        ...
        >
          <div className="grid-cols-form grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-6">
              <Input.Root>
                <Input.Control id="firstName" defaultValue={'Thayná'} />
              </Input.Root>
              <Input.Root>
                <Input.Control defaultValue={'Gitirana'} />
              </Input.Root>
            </div>
            <div />
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pt-5">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue={'thaynalgitirana@gmail.com'}
              />
            </Input.Root>
          </div>
          ...
          <section className="flex items-center justify-end gap-2 pt-5">
            <button
              className="rounded-lg border border-zinc-300 px-4 py-2 text-sm font-semibold text-zinc-700 shadow-sm hover:bg-zinc-50"
              type="button"
            >
